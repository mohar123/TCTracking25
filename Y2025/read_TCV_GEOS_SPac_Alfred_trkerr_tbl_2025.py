...
beg_date = datetime.datetime(year=2025, month=3, day=1, hour=6)
end_date = datetime.datetime(year=2025, month=3, day=6, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M03/D01/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250301_00+"
beg_date = datetime.datetime(year=2025, month=3, day=1, hour=6)
end_date = datetime.datetime(year=2025, month=3, day=5, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M03/D02/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250302_00+"
beg_date = datetime.datetime(year=2025, month=3, day=2, hour=0)
end_date = datetime.datetime(year=2025, month=3, day=6, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M03/D03/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250303_00+"
beg_date = datetime.datetime(year=2025, month=3, day=3, hour=0)
end_date = datetime.datetime(year=2025, month=3, day=6, hour=18)
...
#list if lat >=dely ....
        ...
        #lat_slice1 = lat_slice1-0.4
        #lat_slice2 = lat_slice2+2.
        #lon_slice1 = lon_slice1+(-.5)
        #lon_slice2 = lon_slice2+(3.0)
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2
        lat_slice1 = lat_slice1+(-1.5)
        lat_slice2 = lat_slice2+1.5
        lon_slice1 = lon_slice1+(-1.2)
        lon_slice2 = lon_slice2+(2.0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M03/D04/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250304_00+"
beg_date = datetime.datetime(year=2025, month=3, day=4, hour=0)
end_date = datetime.datetime(year=2025, month=3, day=6, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M03/D05/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250305_00+"
beg_date = datetime.datetime(year=2025, month=3, day=5, hour=0)
end_date = datetime.datetime(year=2025, month=3, day=10, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M03/D06/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250306_00+"
beg_date = datetime.datetime(year=2025, month=3, day=6, hour=0)
end_date = datetime.datetime(year=2025, month=3, day=10, hour=18)
...
#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['01/00Z'],dft2['02/00Z'],dft3['03/00Z'],dft4['04/00Z'],dft5['05/00Z'],dft6['06/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = 150,160.,-20.,-35.
...
#ax.plot([lon_all5], [lat_all4], 'r*', transform=data_transform,color="skyblue", markersize=8)
...
ax.set_title('TC Track Forecast: Alfred South Pacific 2025')
...
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 02/00Z",transform=data_transform,color="limegreen")
p4, = ax.plot(lon_all3,lat_all3, label="Fcst Init: 03/00Z",transform=data_transform,color="yellowgreen")
p5, = ax.plot(lon_all4,lat_all4, label="Fcst Init: 04/00Z",transform=data_transform,color="green")
p6, = ax.plot(lon_all5,lat_all5, label="Fcst Init: 05/00Z",transform=data_transform,color="lightskyblue")
p7, = ax.plot(lon_all6,lat_all6, label="Fcst Init: 06/00Z",transform=data_transform,color="dodgerblue")

ax.legend(handles=[p1,p2,p3,p4,p5,p6,p7],prop={"size":6},ncol=2)
...
plt.savefig('TCAlfred_SPac_table_2025.png')
plt.show()
sys.exit()
#-------------
#TABLE
