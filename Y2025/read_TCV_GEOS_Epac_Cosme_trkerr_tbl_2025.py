...
beg_date = datetime.datetime(year=2025, month=6, day=9, hour=00)
end_date = datetime.datetime(year=2025, month=6, day=11, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M06/D09/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250609_00+"
beg_date = datetime.datetime(year=2025, month=6, day=9, hour=0)
end_date = datetime.datetime(year=2025, month=6, day=11, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M06/D10/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250610_00+"
beg_date = datetime.datetime(year=2025, month=6, day=10, hour=0)
end_date = datetime.datetime(year=2025, month=6, day=11, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M06/D10/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250610_00+"
beg_date = datetime.datetime(year=2025, month=6, day=11, hour=0)
end_date = datetime.datetime(year=2025, month=6, day=11, hour=18)
...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','09/00Z'])
#print(dft2)
#sys.exit()
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','10/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','11/00Z'])

#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['09/00Z'],dft2['10/00Z'],dft3['11/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -108.,-117.,10.,19.
...
ax.set_title('TC Track Forecast: Cosme East Pacific 2025')

p1, = ax.plot(lon_obs,lat_obs, label="TC Vitals",transform=data_transform,color="black")
p2, = ax.plot(lon_all1,lat_all1, label="Fcst Init: 9/00Z",transform=data_transform,color="lightgreen")
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 10/00Z",transform=data_transform,color="cyan")
p4, = ax.plot(lon_all3,lat_all3, label="Fcst Init: 11/00Z",transform=data_transform,color="blue")
...
plt.savefig('TCCosme_table_2025.png')
plt.show()
sys.exit()
#-------------
#TABLE
