...
beg_date = datetime.datetime(year=2025, month=10, day=22, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=31, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M10/D22/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251022_00+"
beg_date = datetime.datetime(year=2025, month=10, day=22, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=27, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M10/D23/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251023_00+"
beg_date = datetime.datetime(year=2025, month=10, day=23, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=28, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M10/D24/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251024_00+"
beg_date = datetime.datetime(year=2025, month=10, day=24, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=29, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M10/D25/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251025_00+"
beg_date = datetime.datetime(year=2025, month=10, day=25, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=30, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M10/D26/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251026_00+"
beg_date = datetime.datetime(year=2025, month=10, day=26, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=31, hour=0)
...
print(sel_lat_lon.iloc[0]['c2'])
lat_slice1 = (sel_lat_lon.iloc[0]['c2'])
lat_slice2 = lat_slice1 + 0.1
print(sel_lat_lon.iloc[0]['c3'])
lon_slice1 = (sel_lat_lon.iloc[0]['c3'])
lon_slice2 = lon_slice1 + 0.1
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M10/D27/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251027_00+"
beg_date = datetime.datetime(year=2025, month=10, day=27, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=31, hour=0)
...
#list if lat >=dely ....
        ...
        lon_slice2 = lon_slice2+.7
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2)
#print(tim_all6,lat_all6,lon_all6,slp_min_all6)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M10/D28/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251028_00+"
beg_date = datetime.datetime(year=2025, month=10, day=28, hour=0)
end_date = datetime.datetime(year=2025, month=11, day=1, hour=0)
...
#list if lat >=dely ....
        ...
        lat_slice1 = lat_slice1+.2
        lat_slice2 = lat_slice2+1.
        lon_slice1 = lon_slice1+.2
        lon_slice2 = lon_slice2+.5
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2)
#print(tim_all7,lat_all7,lon_all7,slp_min_all7)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M10/D29/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251029_00+"
beg_date = datetime.datetime(year=2025, month=10, day=29, hour=0)
end_date = datetime.datetime(year=2025, month=11, day=2, hour=0)
...
print(sel_lat_lon.iloc[0]['c2'])
lat_slice1 = (sel_lat_lon.iloc[0]['c2'])
lat_slice2 = lat_slice1 + 0.5
print(sel_lat_lon.iloc[0]['c3'])
lon_slice1 = (sel_lat_lon.iloc[0]['c3'])
lon_slice2 = lon_slice1 + 0.5
...
#list if lat >=dely ....
        ...
        lon_slice2 = lon_slice2+.5
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2)
#print(tim_all8,lat_all8,lon_all8,slp_min_all8)
df8 = pd.DataFrame((zip(tim_all8,lat_all8,lon_all8,slp_min_all8,fcst_all8)), columns = ['c1','c2','c3','c4','c5'])
print(df8)
#sys.exit()
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M10/D30/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251030_00+"
beg_date = datetime.datetime(year=2025, month=10, day=30, hour=0)
end_date = datetime.datetime(year=2025, month=11, day=2, hour=0)

lon_all9, lat_all9, slp_min_all9, tim_all9, fcst_all9 = [], [], [], [], []
del_lat = 2.0
del_lon = 4.0
sel_lat_lon = (dfo[['c1','c2','c3']][dfo['c1']== beg_date.strftime("%Y%m%d%H")])
print(sel_lat_lon.iloc[0]['c2'])
...
#list if lat >=dely ....
        ...
        if lat_all9:
           if (lat1 <= lat_all9[-1]+del_lat) and (lat1 >= lat_all9[-1]-del_lat) and \
              (lon1 <= lon_all9[-1]+del_lon) and (lon1 >= lon_all9[-1]-del_lon):
              lat_all9.append(lat1)
              slp_min_all9.append(slp_1_min)
              lon_all9.append(lon1)
              tim_all9.append(ds1)
              fcst_all9.append(fcst_diff1)
        else:
            slp_min_all9.append(slp_1_min)
            lon_all9.append(lon1)
            lat_all9.append(lat1)
        ...
        lon_slice2 = lon_slice2+.7
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2)
#print(tim_all9,lat_all9,lon_all9,slp_min_all9)
df9 = pd.DataFrame((zip(tim_all9,lat_all9,lon_all9,slp_min_all9,fcst_all9)), columns = ['c1','c2','c3','c4','c5'])
print(df9)
#sys.exit()
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M10/D31/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251031_00+"
beg_date = datetime.datetime(year=2025, month=10, day=31, hour=0)
end_date = datetime.datetime(year=2025, month=11, day=3, hour=0)

lon_all10, lat_all10, slp_min_all10, tim_all10, fcst_all10 = [], [], [], [], []
del_lat = 2.0
del_lon = 4.0
sel_lat_lon = (dfo[['c1','c2','c3']][dfo['c1']== beg_date.strftime("%Y%m%d%H")])
print(sel_lat_lon.iloc[0]['c2'])
...
#list if lat >=dely ....
        ...
        if lat_all10:
           if (lat1 <= lat_all10[-1]+del_lat) and (lat1 >= lat_all10[-1]-del_lat) and \
              (lon1 <= lon_all10[-1]+del_lon) and (lon1 >= lon_all10[-1]-del_lon):
              lat_all10.append(lat1)
              slp_min_all10.append(slp_1_min)
              lon_all10.append(lon1)
              tim_all10.append(ds1)
              fcst_all10.append(fcst_diff1)
        else:
            slp_min_all10.append(slp_1_min)
            lon_all10.append(lon1)
            lat_all10.append(lat1)
        ...
        lon_slice2 = lon_slice2+.7
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2)
#print(tim_all10,lat_all10,lon_all10,slp_min_all10)
df10 = pd.DataFrame((zip(tim_all10,lat_all10,lon_all10,slp_min_all10,fcst_all10)), columns = ['c1','c2','c3','c4','c5'])
print(df10)
#sys.exit()
#-------------------------------------------
#-----------------------------------------------------------
...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','22/00Z'])
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','23/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','24/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','25/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all5,trk_err_all5)), columns = ['FCST_HR','26/00Z'])
...
dft6 = pd.DataFrame((zip(trk_fcst_all6,trk_err_all6)), columns = ['FCST_HR','27/00Z'])
...
dft7 = pd.DataFrame((zip(trk_fcst_all7,trk_err_all7)), columns = ['FCST_HR','28/00Z'])
...
dft8 = pd.DataFrame((zip(trk_fcst_all8,trk_err_all8)), columns = ['FCST_HR','29/00Z'])

trk_err_all9,trk_tim_all9,trk_lat_all9,trk_lon_all9,trk_slp_min_all9,trk_fcst_all9 = [],[],[],[],[],[]
for idx1, val1 in enumerate(tim_obs):
  for idx2, val2 in enumerate(tim_all9):
      if (tim_obs[idx1]==tim_all9[idx2]):
          err=(distance(lat_all9[idx2], lat_obs[idx1], lon_all9[idx2], lon_obs[idx1]))*0.54
          trk_err_all9.append(err)
          trk_tim_all9.append(tim_all9[idx2])
          trk_lat_all9.append(lat_all9[idx2])
          trk_lon_all9.append(lon_all9[idx2])
          trk_slp_min_all9.append(slp_min_all9[idx2])
          trk_fcst_all9.append(fcst_all9[idx2])
dft9 = pd.DataFrame((zip(trk_fcst_all9,trk_err_all9)), columns = ['FCST_HR','30/00Z'])

trk_err_all10,trk_tim_all10,trk_lat_all10,trk_lon_all10,trk_slp_min_all10,trk_fcst_all10 = [],[],[],[],[],[]
for idx1, val1 in enumerate(tim_obs):
  for idx2, val2 in enumerate(tim_all10):
      if (tim_obs[idx1]==tim_all10[idx2]):
          err=(distance(lat_all10[idx2], lat_obs[idx1], lon_all10[idx2], lon_obs[idx1]))*0.54
          trk_err_all10.append(err)
          trk_tim_all10.append(tim_all10[idx2])
          trk_lat_all10.append(lat_all10[idx2])
          trk_lon_all10.append(lon_all10[idx2])
          trk_slp_min_all10.append(slp_min_all10[idx2])
          trk_fcst_all10.append(fcst_all10[idx2])
dft10 = pd.DataFrame((zip(trk_fcst_all10,trk_err_all10)), columns = ['FCST_HR','31/00Z'])

#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft2['FCST_HR'],dft3['FCST_HR'],dft4['FCST_HR'],dft5['FCST_HR'],dft6['FCST_HR'],dft7['FCST_HR'],dft8['FCST_HR'],dft9['FCST_HR'],dft10['FCST_HR']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -90.,-62.,10.,32.
...
ax.set_title('TC Track Forecast: Melissa Atlantic 2025')

p1, = ax.plot(lon_obs,lat_obs, label="TC Vitals",transform=data_transform,color="black")
p2, = ax.plot(lon_all1,lat_all1, label="Fcst Init: 2200Z",transform=data_transform,color="lightgreen")
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 23/00Z",transform=data_transform,color="lime")
p4, = ax.plot(lon_all3,lat_all3, label="Fcst Init: 24/00Z",transform=data_transform,color="green")
p5, = ax.plot(lon_all4,lat_all4, label="Fcst Init: 25/00Z",transform=data_transform,color="paleturquoise")
p6, = ax.plot(lon_all5,lat_all5, label="Fcst Init: 26/00Z",transform=data_transform,color="cyan")
p7, = ax.plot(lon_all6,lat_all6, label="Fcst Init: 27/00Z",transform=data_transform,color="dodgerblue")
p8, = ax.plot(lon_all7,lat_all7, label="Fcst Init: 28/00Z",transform=data_transform,color="deepskyblue")
p9, = ax.plot(lon_all8,lat_all8, label="Fcst Init: 29/00Z",transform=data_transform,color="lightgreen")
p10, = ax.plot(lon_all9,lat_all9, label="Fcst Init: 30/00Z",transform=data_transform,color="lime")
p11, = ax.plot(lon_all10,lat_all10, label="Fcst Init: 31/00Z",transform=data_transform,color="green")

ax.legend(handles=[p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11],prop={"size":6},ncol=3)
...
plt.savefig('TCMelissa_table_2025.png')
plt.show()
sys.exit()
