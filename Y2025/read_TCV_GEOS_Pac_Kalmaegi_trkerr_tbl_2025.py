...
beg_date = datetime.datetime(year=2025, month=11, day=2, hour=0)
end_date = datetime.datetime(year=2025, month=11, day=6, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M11/D02/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251102_00+"
beg_date = datetime.datetime(year=2025, month=11, day=2, hour=0)
end_date = datetime.datetime(year=2025, month=11, day=6, hour=18)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M11/D03/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251103_00+"
beg_date = datetime.datetime(year=2025, month=11, day=3, hour=0)
end_date = datetime.datetime(year=2025, month=11, day=7, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M11/D04/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251104_00+"
beg_date = datetime.datetime(year=2025, month=11, day=4, hour=0)
end_date = datetime.datetime(year=2025, month=11, day=7, hour=0)
...
print(sel_lat_lon.iloc[0]['c3'])
lon_slice1 = (sel_lat_lon.iloc[0]['c3'])-0.2
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M11/D05/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20251105_00+"
beg_date = datetime.datetime(year=2025, month=11, day=5, hour=0)
end_date = datetime.datetime(year=2025, month=11, day=7, hour=0)
...
print(sel_lat_lon.iloc[0]['c3'])
lon_slice1 = (sel_lat_lon.iloc[0]['c3'])-1.0
...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','02/00Z'])
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','03/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','04/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','05/00Z'])

#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft2['FCST_HR'],dft3['FCST_HR'],dft4['FCST_HR']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = 108.,140.,7.,17.
...
ax.set_title('TC Track Forecast: Kalmaegi Pacific 2025')

p1, = ax.plot(lon_obs,lat_obs, label="TC Vitals",transform=data_transform,color="black")
p2, = ax.plot(lon_all1,lat_all1, label="Fcst Init: 02/00Z",transform=data_transform,color="lightgreen")
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 03/00Z",transform=data_transform,color="lime")
p4, = ax.plot(lon_all3,lat_all3, label="Fcst Init: 04/00Z",transform=data_transform,color="green")
p5, = ax.plot(lon_all4,lat_all4, label="Fcst Init: 05/00Z",transform=data_transform,color="paleturquoise")

ax.legend(handles=[p1,p2,p3,p4,p5],prop={"size":6},ncol=3)
...
plt.savefig('TCKalmaegi_table_2025.png')
plt.show()
sys.exit()
