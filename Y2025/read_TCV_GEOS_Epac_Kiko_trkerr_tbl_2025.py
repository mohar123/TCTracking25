...
beg_date = datetime.datetime(year=2025, month=9, day=1, hour=00)
end_date = datetime.datetime(year=2025, month=9, day=9, hour=0)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D01/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250901_00+"
beg_date = datetime.datetime(year=2025, month=9, day=1, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=5, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D02/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250902_00+"
beg_date = datetime.datetime(year=2025, month=9, day=2, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=6, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D03/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250903_00+"
beg_date = datetime.datetime(year=2025, month=9, day=3, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=6, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D04/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250904_00+"
beg_date = datetime.datetime(year=2025, month=9, day=4, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=7, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D05/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250905_00+"
beg_date = datetime.datetime(year=2025, month=9, day=5, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=9, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D06/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250906_00+"
beg_date = datetime.datetime(year=2025, month=9, day=6, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=9, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D07/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250907_00+"
beg_date = datetime.datetime(year=2025, month=9, day=7, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=9, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D08/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250908_00+"
beg_date = datetime.datetime(year=2025, month=9, day=8, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=9, hour=0)
...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','01/00Z'])
#print(dft2)
#sys.exit()
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','02/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','03/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','04/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all5,trk_err_all5)), columns = ['FCST_HR','05/00Z'])
...
dft6 = pd.DataFrame((zip(trk_fcst_all6,trk_err_all6)), columns = ['FCST_HR','06/00Z'])
...
dft7 = pd.DataFrame((zip(trk_fcst_all7,trk_err_all7)), columns = ['FCST_HR','07/00Z'])
...
dft8 = pd.DataFrame((zip(trk_fcst_all8,trk_err_all8)), columns = ['FCST_HR','08/00Z'])
#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['01/00Z'],dft2['02/00Z'],dft3['03/00Z'],dft4['04/00Z'],dft5['05/00Z'],dft6['06/00Z'],dft7['07/00Z'],dft8['08/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -120.,-154.,10.,23.
...
ax.set_title('TC Track Forecast: Kiko East Pacific 2025')

p1, = ax.plot(lon_obs,lat_obs, label="TC Vitals",transform=data_transform,color="black")
p2, = ax.plot(lon_all1,lat_all1, label="Fcst Init: 01/00Z",transform=data_transform,color="lightgreen")
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 02/00Z",transform=data_transform,color="lime")
p4, = ax.plot(lon_all3,lat_all3, label="Fcst Init: 03/00Z",transform=data_transform,color="green")
p5, = ax.plot(lon_all4,lat_all4, label="Fcst Init: 04/00Z",transform=data_transform,color="lightskyblue")
p6, = ax.plot(lon_all5,lat_all5, label="Fcst Init: 05/00Z",transform=data_transform,color="blue")
p7, = ax.plot(lon_all6,lat_all6, label="Fcst Init: 06/00Z",transform=data_transform,color="dodgerblue")
p8, = ax.plot(lon_all7,lat_all7, label="Fcst Init: 07/00Z",transform=data_transform,color="lightgreen")
p9, = ax.plot(lon_all8,lat_all8, label="Fcst Init: 08/00Z",transform=data_transform,color="limegreen")
...
plt.savefig('TCKiko_table_2025.png')
plt.show()
sys.exit()
#-------------
#TABLE
