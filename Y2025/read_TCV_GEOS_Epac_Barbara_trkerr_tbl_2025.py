...
end_date = datetime.datetime(year=2025, month=6, day=11, hour=6)
...
#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['09/00Z'],dft2['10/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -102.,-114.,13.,23.
...
ax.set_title('TC Track Forecast: Barbara East Pacific 2025')
...
plt.savefig('TCBarbara_table_2025.png')
plt.show()
sys.exit()
#-------------
#TABLE
