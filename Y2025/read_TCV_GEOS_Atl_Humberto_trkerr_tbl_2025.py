...
end_date = datetime.datetime(year=2025, month=10, day=1, hour=18)
...
beg_date = datetime.datetime(year=2025, month=9, day=25, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=30, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D26/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250926_00+"
beg_date = datetime.datetime(year=2025, month=9, day=26, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=1, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D27/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250927_00+"
beg_date = datetime.datetime(year=2025, month=9, day=27, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=1, hour=12)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D28/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250928_00+"
beg_date = datetime.datetime(year=2025, month=9, day=28, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=1, hour=18)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D29/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250929_00+"
beg_date = datetime.datetime(year=2025, month=9, day=29, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=1, hour=18)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D30/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250930_00+"
beg_date = datetime.datetime(year=2025, month=9, day=30, hour=0)
end_date = datetime.datetime(year=2025, month=10, day=1, hour=18)
...
dft4 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','28/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all5,trk_err_all5)), columns = ['FCST_HR','29/00Z'])
...
dft6 = pd.DataFrame((zip(trk_fcst_all6,trk_err_all6)), columns = ['FCST_HR','30/00Z'])

#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft2['FCST_HR'],dft3['FCST_HR'],dft4['FCST_HR'],dft5['FCST_HR'],dft6['FCST_HR']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -74.,-50.,16.,40.
...
ax.set_title('TC Track Forecast: Humberto Atlantic 2025')

p1, = ax.plot(lon_obs,lat_obs, label="TC Vitals",transform=data_transform,color="black")
p2, = ax.plot(lon_all1,lat_all1, label="Fcst Init: 2500Z",transform=data_transform,color="lightgreen")
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 26/00Z",transform=data_transform,color="lime")
p4, = ax.plot(lon_all3,lat_all3, label="Fcst Init: 27/00Z",transform=data_transform,color="green")
p5, = ax.plot(lon_all4,lat_all4, label="Fcst Init: 28/00Z",transform=data_transform,color="paleturquoise")
p6, = ax.plot(lon_all5,lat_all5, label="Fcst Init: 29/00Z",transform=data_transform,color="cyan")
p7, = ax.plot(lon_all6,lat_all6, label="Fcst Init: 30/00Z",transform=data_transform,color="dodgerblue")

ax.legend(handles=[p1,p2,p3,p4,p5,p6,p7],prop={"size":6},ncol=3)
...
plt.savefig('TCHumberto_table_2025.png')
plt.show()
sys.exit()
