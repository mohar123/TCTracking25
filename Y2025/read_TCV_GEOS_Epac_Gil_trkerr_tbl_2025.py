...
beg_date = datetime.datetime(year=2025, month=8, day=1, hour=00)
end_date = datetime.datetime(year=2025, month=8, day=3, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D02/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250802_00+"
beg_date = datetime.datetime(year=2025, month=8, day=2, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=3, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D03/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250803_00+"
beg_date = datetime.datetime(year=2025, month=8, day=3, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=3, hour=18)
...
#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['01/00Z'],dft2['02/00Z'],dft3['03/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -115.,-138.,10.,23.
...
ax.set_title('TC Track Forecast: Gil East Pacific 2025')
...
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 02/00Z",transform=data_transform,color="cyan")
p4, = ax.plot(lon_all3,lat_all3, label="Fcst Init: 03/00Z",transform=data_transform,color="blue")
...
plt.savefig('TCGil_table_2025.png')
plt.show()
sys.exit()
#-------------
#TABLE
