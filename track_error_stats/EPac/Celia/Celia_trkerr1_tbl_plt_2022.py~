...
beg_date = datetime.datetime(year=2022, month=5, day=29, hour=00)
end_date = datetime.datetime(year=2022, month=6, day=1, hour=6)
...
beg_date = datetime.datetime(year=2022, month=5, day=30, hour=00)
end_date = datetime.datetime(year=2022, month=6, day=2, hour=6)
...
end_date = datetime.datetime(year=2022, month=6, day=1, hour=12)
...
summarydf = pd.concat([dft1,dft2['30/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Agatha.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['29/00Z','30/00Z']].mean(axis=1)
with open('summary_4onestats_Agatha.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['29/00Z','30/00Z']].std(axis=1)
summarydf['count'] = summarydf[['29/00Z','30/00Z']].count(axis=1)
