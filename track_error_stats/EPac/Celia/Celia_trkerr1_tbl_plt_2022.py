...
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M06/D23/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220623_00+"
beg_date = datetime.datetime(year=2022, month=6, day=23, hour=00)
end_date = datetime.datetime(year=2022, month=6, day=28, hour=6)
...
#---
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M06/D24/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220624_00+"
beg_date = datetime.datetime(year=2022, month=6, day=24, hour=00)
end_date = datetime.datetime(year=2022, month=6, day=29, hour=6)
...
#---
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M06/D25/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220625_00+"
beg_date = datetime.datetime(year=2022, month=6, day=25, hour=00)
end_date = datetime.datetime(year=2022, month=6, day=29, hour=6)
...
#---
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M06/D26/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220626_00+"
beg_date = datetime.datetime(year=2022, month=6, day=26, hour=00)
end_date = datetime.datetime(year=2022, month=6, day=29, hour=6)
...
beg_date = datetime.datetime(year=2022, month=6, day=23, hour=0)
end_date = datetime.datetime(year=2022, month=6, day=29, hour=6)
...
print(summarydf)
with open('summary_4allstats_Celia.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['23/00Z','24/00Z','25/00Z','26/00Z']].mean(axis=1)
with open('summary_4onestats_Celia.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['23/00Z','24/00Z','25/00Z','26/00Z']].std(axis=1)
summarydf['count'] = summarydf[['23/00Z','24/00Z','25/00Z','26/00Z']].count(axis=1)
