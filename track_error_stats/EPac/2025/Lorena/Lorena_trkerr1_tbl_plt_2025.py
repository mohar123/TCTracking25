...
#----------------------------------------
summarydf = pd.concat([dft1,dft2['04/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Lorena.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['03/00Z','04/00Z']].mean(axis=1)
with open('summary_4onestats_Lorena.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['03/00Z','04/00Z']].std(axis=1)
summarydf['count'] = summarydf[['03/00Z','04/00Z']].count(axis=1)
