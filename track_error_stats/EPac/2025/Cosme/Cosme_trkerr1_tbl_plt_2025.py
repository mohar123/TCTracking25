...
#sys.exit()
#----------------------------------------
summarydf = pd.concat([dft1,dft2['10/00Z'],dft3['11/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Cosme.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['09/00Z','10/00Z','11/00Z']].mean(axis=1)
with open('summary_4onestats_Cosme.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['09/00Z','10/00Z','11/00Z']].std(axis=1)
summarydf['count'] = summarydf[['09/00Z','10/00Z','11/00Z']].count(axis=1)
