...
#sys.exit()
#----------------------------------------
summarydf = pd.concat([dft1,dft2['01/00Z'],dft3['02/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Flossie.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['30/00Z','01/00Z','02/00Z']].mean(axis=1)
with open('summary_4onestats_Flossie.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['30/00Z','01/00Z','02/00Z']].std(axis=1)
summarydf['count'] = summarydf[['30/00Z','01/00Z','02/00Z']].count(axis=1)
