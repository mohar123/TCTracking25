...
#sys.exit()
#----------------------------------------
summarydf = pd.concat([dft1,dft2['15/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Dalila.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['14/00Z','15/00Z']].mean(axis=1)
with open('summary_4onestats_Dalila.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['14/00Z','15/00Z']].std(axis=1)
summarydf['count'] = summarydf[['14/00Z','15/00Z']].count(axis=1)
