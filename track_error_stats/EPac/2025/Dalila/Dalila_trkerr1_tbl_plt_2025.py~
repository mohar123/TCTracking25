...
beg_date = datetime.datetime(year=2025, month=6, day=14, hour=00)
end_date = datetime.datetime(year=2025, month=6, day=16, hour=6)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M06/D14/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250614_00+"
beg_date = datetime.datetime(year=2025, month=6, day=14, hour=0)
end_date = datetime.datetime(year=2025, month=6, day=16, hour=6)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M06/D15/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250615_00+"
beg_date = datetime.datetime(year=2025, month=6, day=15, hour=0)
end_date = datetime.datetime(year=2025, month=6, day=16, hour=6)
...
#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['14/00Z'],dft2['15/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -100.,-115.,10.,20.
...
ax.set_title('TC Track Forecast: Dalila East Pacific 2025')

p1, = ax.plot(lon_obs,lat_obs, label="TC Vitals",transform=data_transform,color="black")
p2, = ax.plot(lon_all1,lat_all1, label="Fcst Init: 14/00Z",transform=data_transform,color="lightgreen")
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 15/00Z",transform=data_transform,color="cyan")
...
plt.savefig('TCDalila_table_2025.png')
plt.show()
sys.exit()
#-------------
#TABLE
