...
#sys.exit()
#----------------------------------------
summarydf = pd.concat([dft1,dft2['29/00Z'],dft3['30/00Z'],dft4['31/00Z'],dft5['01/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Iona.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['28/00Z','29/00Z','30/00Z','31/00Z','01/00Z']].mean(axis=1)
with open('summary_4onestats_Iona.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['28/00Z','29/00Z','30/00Z','31/00Z','01/00Z']].std(axis=1)
summarydf['count'] = summarydf[['28/00Z','29/00Z','30/00Z','31/00Z','01/00Z']].count(axis=1)
