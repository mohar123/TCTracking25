...
#sys.exit()
#----------------------------------------
summarydf = pd.concat([dft1,dft2['02/00Z'],dft3['03/00Z'],dft4['04/00Z'],dft5['05/00Z'],dft6['06/00Z'],dft7['07/00Z'],dft8['08/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Kiko.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['01/00Z','02/00Z','03/00Z','04/00Z','05/00Z','06/00Z','07/00Z','08/00Z']].mean(axis=1)
with open('summary_4onestats_Kiko.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['01/00Z','02/00Z','03/00Z','04/00Z','05/00Z','06/00Z','07/00Z','08/00Z']].std(axis=1)
summarydf['count'] = summarydf[['01/00Z','02/00Z','03/00Z','04/00Z','05/00Z','06/00Z','07/00Z','08/00Z']].count(axis=1)
