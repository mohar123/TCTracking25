...
#sys.exit()
#----------------------------------------
summarydf = pd.concat([dft1,dft2['02/00Z'],dft3['03/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Gil.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['01/00Z','02/00Z','03/00Z']].mean(axis=1)
with open('summary_4onestats_Gil.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['01/00Z','02/00Z','03/00Z']].std(axis=1)
summarydf['count'] = summarydf[['01/00Z','02/00Z','03/00Z']].count(axis=1)
