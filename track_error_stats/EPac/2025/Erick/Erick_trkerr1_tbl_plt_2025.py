...
#sys.exit()
#----------------------------------------
summarydf = pd.concat([dft1,dft2['19/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Erick.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['18/00Z','19/00Z']].mean(axis=1)
with open('summary_4onestats_Erick.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['18/00Z','19/00Z']].std(axis=1)
summarydf['count'] = summarydf[['18/00Z','19/00Z']].count(axis=1)
