...
beg_date = datetime.datetime(year=2025, month=6, day=18, hour=00)
end_date = datetime.datetime(year=2025, month=6, day=20, hour=00)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M06/D18/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250618_00+"
beg_date = datetime.datetime(year=2025, month=6, day=18, hour=0)
end_date = datetime.datetime(year=2025, month=6, day=20, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M06/D19/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250619_00+"
beg_date = datetime.datetime(year=2025, month=6, day=19, hour=0)
end_date = datetime.datetime(year=2025, month=6, day=20, hour=0)
...
#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['18/00Z'],dft2['19/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -93.,-103.,10.,20.
...
ax.set_title('TC Track Forecast: Erick East Pacific 2025')
...
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 19/00Z",transform=data_transform,color="cyan")

#ax.legend(handles=[p1,p2,p3,p4,p5],prop={"size":6},ncol=2,bbox_to_anchor=(.85, -0.15),fancybox=True)
ax.legend(handles=[p1,p2,p3],prop={"size":6},ncol=3)
...
plt.savefig('TCErick_table_2025.png')
plt.show()
sys.exit()
#-------------
#TABLE
