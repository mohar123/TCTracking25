...
beg_date = datetime.datetime(year=2025, month=5, day=30, hour=00)
end_date = datetime.datetime(year=2025, month=5, day=31, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M05/D30/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250530_00+"
beg_date = datetime.datetime(year=2025, month=5, day=30, hour=0)
end_date = datetime.datetime(year=2025, month=5, day=31, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M05/D31/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250531_00+"
beg_date = datetime.datetime(year=2025, month=5, day=31, hour=0)
end_date = datetime.datetime(year=2025, month=5, day=31, hour=18)
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','31/00Z'])

#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['30/00Z'],dft2['31/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -103.,-113.,12.,22.
...
ax.set_title('TC Track Forecast: Alvin East Pacific 2025')
...
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 31/00Z",transform=data_transform,color="cyan")
...
plt.savefig('TCAlvin_table_2025.png')
plt.show()
sys.exit()
#-------------
#TABLE
