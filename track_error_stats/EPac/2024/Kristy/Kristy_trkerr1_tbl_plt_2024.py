...
beg_date = datetime.datetime(year=2024, month=10, day=22, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=28, hour=0)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D22/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241022_00+"
beg_date = datetime.datetime(year=2024, month=10, day=22, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=27, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D23/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241023_00+"
beg_date = datetime.datetime(year=2024, month=10, day=23, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=28, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D24/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241024_00+"
beg_date = datetime.datetime(year=2024, month=10, day=24, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=28, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D25/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241025_00+"
beg_date = datetime.datetime(year=2024, month=10, day=25, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=28, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D26/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241026_00+"
beg_date = datetime.datetime(year=2024, month=10, day=26, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=28, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D27/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241027_00+"
beg_date = datetime.datetime(year=2024, month=10, day=27, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=28, hour=0)
...
#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['22/00Z'],dft2['23/00Z'],dft3['24/00Z'],dft4['25/00Z'],dft5['26/00Z'],dft6['27/00Z']], axis=1)
print(summarydf)
#sys.exit()

#----------------#STATS#------------------------
summarydf = pd.concat([dft1,dft2['23/00Z'],dft3['24/00Z'],dft4['25/00Z'],dft5['26/00Z'],dft6['27/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Kristy.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['22/00Z','23/00Z','24/00Z','25/00Z','26/00Z','27/00Z']].mean(axis=1)
with open('summary_4onestats_Kristy.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['22/00Z','23/00Z','24/00Z','25/00Z','26/00Z','27/00Z']].std(axis=1)
summarydf['count'] = summarydf[['22/00Z','23/00Z','24/00Z','25/00Z','26/00Z','27/00Z']].count(axis=1)
