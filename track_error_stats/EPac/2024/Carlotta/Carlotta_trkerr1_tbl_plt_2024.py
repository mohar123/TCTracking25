...
beg_date = datetime.datetime(year=2024, month=8, day=1, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=5, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D01/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240801_00+"
beg_date = datetime.datetime(year=2024, month=8, day=1, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=5, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D02/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240802_00+"
beg_date = datetime.datetime(year=2024, month=8, day=2, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=5, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D03/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240803_00+"
beg_date = datetime.datetime(year=2024, month=8, day=3, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=5, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D04/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240804_00+"
beg_date = datetime.datetime(year=2024, month=8, day=4, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=5, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D05/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240805_00+"
beg_date = datetime.datetime(year=2024, month=8, day=5, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=5, hour=18)
...
#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['01/00Z'],dft2['02/00Z'],dft3['03/00Z'],dft4['04/00Z'],dft5['05/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STAS CALC
...
summarydf = pd.concat([dft1,dft2['02/00Z'],dft3['03/00Z'],dft4['04/00Z'],dft5['05/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Carlotta.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['01/00Z','02/00Z','03/00Z','04/00Z','05/00Z']].mean(axis=1)
with open('summary_4onestats_Carlotta.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['01/00Z','02/00Z','03/00Z','04/00Z','05/00Z']].std(axis=1)
summarydf['count'] = summarydf[['01/00Z','02/00Z','03/00Z','04/00Z','05/00Z']].count(axis=1)
