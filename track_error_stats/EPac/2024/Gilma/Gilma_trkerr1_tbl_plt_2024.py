...
end_date = datetime.datetime(year=2024, month=8, day=28, hour=18)
...
beg_date = datetime.datetime(year=2024, month=8, day=20, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=26, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D21/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240821_00+"
beg_date = datetime.datetime(year=2024, month=8, day=21, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=27, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D22/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240822_00+"
beg_date = datetime.datetime(year=2024, month=8, day=22, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=28, hour=0)
...
print(sel_lat_lon.iloc[0]['c2'])
lat_slice1 = (sel_lat_lon.iloc[0]['c2'])
lat_slice2 = lat_slice1 + 1.0
print(sel_lat_lon.iloc[0]['c3'])
lon_slice1 = (sel_lat_lon.iloc[0]['c3'])
lon_slice2 = lon_slice1 + (10.)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D23/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240823_00+"
beg_date = datetime.datetime(year=2024, month=8, day=23, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=28, hour=18)
...
#list if lat >=dely ....
        ...
        lat_slice1 = lat_slice1+.12
        lat_slice2 = lat_slice2+.12
        lon_slice1 = lon_slice1-1.5
        lon_slice2 = lon_slice2-1.5
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D24/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240824_00+"
beg_date = datetime.datetime(year=2024, month=8, day=24, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=28, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D25/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240825_00+"
beg_date = datetime.datetime(year=2024, month=8, day=25, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=28, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D26/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240826_00+"
beg_date = datetime.datetime(year=2024, month=8, day=26, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=28, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M08/D27/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240827_00+"
beg_date = datetime.datetime(year=2024, month=8, day=27, hour=0)
end_date = datetime.datetime(year=2024, month=8, day=28, hour=18)
...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','20/00Z'])
#print(dft2)
#sys.exit()
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','21/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','22/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','23/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all5,trk_err_all5)), columns = ['FCST_HR','24/00Z'])
...
dft6 = pd.DataFrame((zip(trk_fcst_all6,trk_err_all6)), columns = ['FCST_HR','25/00Z'])
...
dft7 = pd.DataFrame((zip(trk_fcst_all7,trk_err_all7)), columns = ['FCST_HR','26/00Z'])
...
dft8 = pd.DataFrame((zip(trk_fcst_all8,trk_err_all8)), columns = ['FCST_HR','27/00Z'])

#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['20/00Z'],dft2['21/00Z'],dft3['22/00Z'],dft4['23/00Z'],dft5['24/00Z'],dft6['25/00Z'],dft7['26/00Z'],dft8['27/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
# CALCULATE STATISTICS
#----------------------------------------
summarydf = pd.concat([dft1,dft2['21/00Z'],dft3['22/00Z'],dft4['23/00Z'],dft5['24/00Z'],dft6['25/00Z'],dft7['26/00Z'],dft8['27/00Z']], axis=1)
#----------------------------------------
summarydf = pd.concat([dft1,dft2['21/00Z'],dft3['22/00Z'],dft4['23/00Z'],dft5['24/00Z'],dft6['25/00Z'],dft7['26/00Z'],dft8['27/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Gilma.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['20/00Z','21/00Z','22/00Z','23/00Z','24/00Z','25/00Z','26/00Z','27/00Z']].mean(axis=1)
with open('summary_4onestats_Gilma.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['20/00Z','21/00Z','22/00Z','23/00Z','24/00Z','25/00Z','26/00Z','27/00Z']].std(axis=1)
summarydf['count'] = summarydf[['20/00Z','21/00Z','22/00Z','23/00Z','24/00Z','25/00Z','26/00Z','27/00Z']].count(axis=1)
