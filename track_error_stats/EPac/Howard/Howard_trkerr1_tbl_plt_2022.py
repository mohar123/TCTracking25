...
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M08/D08/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220808_00+"
beg_date = datetime.datetime(year=2022, month=8, day=8, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=14, hour=6)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M08/D09/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220809_00+"
beg_date = datetime.datetime(year=2022, month=8, day=9, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=15, hour=6)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M08/D10/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220810_00+"
beg_date = datetime.datetime(year=2022, month=8, day=10, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=16, hour=6)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M08/D11/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220811_00+"
beg_date = datetime.datetime(year=2022, month=8, day=11, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=17, hour=6)
...
beg_date = datetime.datetime(year=2022, month=8, day=8, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=11, hour=12)
...
dft1 = pd.DataFrame((zip(trk_fcst_all,trk_err_all)), columns = ['FCST_HR','08/00Z'])
#print(dft1)
...
dft2 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','09/00Z'])
#print(dft2)
...
dft3 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','10/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','11/00Z'])

summarydf = pd.concat([dft1,dft2['09/00Z'],dft3['10/00Z'],dft4['11/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Howard.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['08/00Z','09/00Z','10/00Z','11/00Z']].mean(axis=1)
with open('summary_4onestats_Howard.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['08/00Z','09/00Z','10/00Z','11/00Z']].std(axis=1)
summarydf['count'] = summarydf[['08/00Z','09/00Z','10/00Z','11/00Z']].count(axis=1)
