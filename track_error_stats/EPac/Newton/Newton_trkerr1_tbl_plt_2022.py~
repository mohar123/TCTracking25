...
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D23/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220923_00+"
beg_date = datetime.datetime(year=2022, month=9, day=23, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=26, hour=0)
...
summarydf = pd.concat([dft1,dft2['24/00Z'],dft3['25/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -120.0,-103.,15.,25.
...
ax.set_title('TC Track and Track errors (Nautical Miles): Newton 2022')
...
p4, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 25/00Z",transform=data_transform,color="cyan")
...
summarydf.update(summarydf[['FCST_HR','23/00Z','24/00Z','25/00Z']].applymap('{:,.0f}'.format))
thetable = plt.table(cellText=summarydf.values,colWidths = [0.1]*5,colLabels=("FCST_HR","23/00Z","24/00Z","25/00Z"),cellLoc = 'center', rowLoc = 'center',loc='bottom', bbox=[0.25, -.95, 0.5, 0.85])
plt.subplots_adjust(left=0.2, bottom=0.2)
#thetable.auto_set_font_size(False)
#thetable.set_fontsize(12)
thetable.scale(1,4)
## change cell properties
plt.savefig('TCNewton_table_2022_15.png')
plt.show()
