...
#STATS CALC
#----------------------------------------
with open('summary_4allstats_Newton.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['23/00Z','24/00Z','25/00Z']].mean(axis=1)
with open('summary_4onestats_Newton.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['23/00Z','24/00Z','25/00Z']].std(axis=1)
summarydf['count'] = summarydf[['23/00Z','24/00Z','25/00Z']].count(axis=1)
