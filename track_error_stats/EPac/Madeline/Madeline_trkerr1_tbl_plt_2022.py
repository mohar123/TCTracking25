...
summarydf = pd.concat([dft1,dft2['20/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STATS CALC
#----------------------------------------
with open('summary_4allstats_Madeline.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['19/00Z','20/00Z']].mean(axis=1)
with open('summary_4onestats_Madeline.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['19/00Z','20/00Z']].std(axis=1)
summarydf['count'] = summarydf[['19/00Z','20/00Z']].count(axis=1)
