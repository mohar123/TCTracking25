...
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M07/D28/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220728_00+"
beg_date = datetime.datetime(year=2022, month=7, day=28, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=2, hour=6)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M07/D29/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220729_00+"
beg_date = datetime.datetime(year=2022, month=7, day=29, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=3, hour=6)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M07/D30/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220730_00+"
beg_date = datetime.datetime(year=2022, month=7, day=30, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=4, hour=6)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M07/D31/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220731_00+"
beg_date = datetime.datetime(year=2022, month=7, day=31, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=5, hour=6)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M08/D01/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220801_00+"
beg_date = datetime.datetime(year=2022, month=8, day=1, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=5, hour=6)
...
beg_date = datetime.datetime(year=2022, month=7, day=28, hour=0)
end_date = datetime.datetime(year=2022, month=8, day=2, hour=12)
...
dft1 = pd.DataFrame((zip(trk_fcst_all,trk_err_all)), columns = ['FCST_HR','28/00Z'])
#print(dft1)
...
dft2 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','29/00Z'])
#print(dft2)
#sys.exit()
...
dft3 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','30/00Z'])
#print(dft3)
...
dft4 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','31/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','1/00Z'])

summarydf = pd.concat([dft1,dft2['29/00Z'],dft3['30/00Z'],dft4['31/00Z'],dft5['1/00Z'],], axis=1)
print(summarydf)
with open('summary_4allstats_Frank.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['28/00Z','29/00Z','30/00Z','31/00Z','1/00Z']].mean(axis=1)
with open('summary_4onestats_Frank.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['28/00Z','29/00Z','30/00Z','31/00Z','1/00Z']].std(axis=1)
summarydf['count'] = summarydf[['28/00Z','29/00Z','30/00Z','31/00Z','1/00Z']].count(axis=1)
