...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M10/D23/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231023_00+"
beg_date = datetime.datetime(year=2023, month=10, day=23, hour=0)
end_date = datetime.datetime(year=2023, month=10, day=26, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M10/D24/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231024_00+"
beg_date = datetime.datetime(year=2023, month=10, day=24, hour=0)
end_date = datetime.datetime(year=2023, month=10, day=26, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M10/D25/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231025_00+"
beg_date = datetime.datetime(year=2023, month=10, day=25, hour=0)
end_date = datetime.datetime(year=2023, month=10, day=26, hour=0)
...
summarydf = pd.concat([dft2['FCST_HR'],dft1['23/00Z'],dft2['24/00Z'],dft3['25/00Z']], axis=1)
print(summarydf)
...
#TABLE
#-------------
with open('summary_4allstats_Otis.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['23/00Z','24/00Z','25/00Z']].mean(axis=1)
with open('summary_4onestats_Otis.txt', 'w') as f:
    f.write(summarydf.to_string())
