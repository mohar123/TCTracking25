...
end_date = datetime.datetime(year=2023, month=9, day=22, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M09/D22/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230922_00+"
beg_date = datetime.datetime(year=2023, month=9, day=22, hour=0)
end_date = datetime.datetime(year=2023, month=9, day=22, hour=18)
...
dft1 = pd.DataFrame((zip(trk_fcst_all,trk_err_all)), columns = ['FCST_HR','20/00Z'])
#print(dft1)
...
dft2 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','21/00Z'])
#print(dft2)
#sys.exit()
...
dft3 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','22/00Z'])
...
#PLOTTING
#----------------------------------------
with open('summary_4allstats_Kenneth.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['20/00Z','21/00Z','22/00Z']].mean(axis=1)
with open('summary_4onestats_Kenneth.txt', 'w') as f:
    f.write(summarydf.to_string())
