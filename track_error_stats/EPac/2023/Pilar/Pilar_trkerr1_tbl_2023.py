...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M10/D31/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231031_00+"
beg_date = datetime.datetime(year=2023, month=10, day=31, hour=0)
end_date = datetime.datetime(year=2023, month=11, day=3, hour=12)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M11/D01/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231101_00+"
beg_date = datetime.datetime(year=2023, month=11, day=1, hour=0)
end_date = datetime.datetime(year=2023, month=11, day=3, hour=12)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M11/D02/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231102_00+"
beg_date = datetime.datetime(year=2023, month=11, day=2, hour=0)
end_date = datetime.datetime(year=2023, month=11, day=3, hour=12)
...
dft1 = pd.DataFrame((zip(trk_fcst_all,trk_err_all)), columns = ['FCST_HR','31/00Z'])
#print(dft1)
...
dft2 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','1/00Z'])
#print(dft2)
#sys.exit()
...
dft3 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','2/00Z'])

summarydf = pd.concat([dft1['FCST_HR'],dft1['31/00Z'],dft2['1/00Z'],dft3['2/00Z']], axis=1)
print(summarydf)
...
#TABLE
#-------------
with open('summary_4allstats_Pilar.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['31/00Z','1/00Z','2/00Z']].mean(axis=1)
with open('summary_4onestats_Pilar.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['31/00Z','1/00Z','2/00Z']].std(axis=1)
summarydf['count'] = summarydf[['31/00Z','1/00Z','2/00Z']].count(axis=1)
