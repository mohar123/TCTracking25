...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M10/D05/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231005_00+"
beg_date = datetime.datetime(year=2023, month=10, day=5, hour=0)
end_date = datetime.datetime(year=2023, month=10, day=11, hour=12)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M10/D06/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231006_00+"
beg_date = datetime.datetime(year=2023, month=10, day=6, hour=0)
end_date = datetime.datetime(year=2023, month=10, day=11, hour=12)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M10/D07/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231007_00+"
beg_date = datetime.datetime(year=2023, month=10, day=7, hour=0)
end_date = datetime.datetime(year=2023, month=10, day=11, hour=12)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M10/D08/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231008_00+"
beg_date = datetime.datetime(year=2023, month=10, day=8, hour=0)
end_date = datetime.datetime(year=2023, month=10, day=11, hour=12)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M10/D09/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231009_00+"
beg_date = datetime.datetime(year=2023, month=10, day=9, hour=0)
end_date = datetime.datetime(year=2023, month=10, day=11, hour=12)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M10/D10/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20231010_00+"
beg_date = datetime.datetime(year=2023, month=10, day=10, hour=0)
end_date = datetime.datetime(year=2023, month=10, day=11, hour=6)
...
dft1 = pd.DataFrame((zip(trk_fcst_all,trk_err_all)), columns = ['FCST_HR','05/00Z'])
#print(dft1)
...
dft2 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','06/00Z'])
#print(dft2)
#sys.exit()
...
dft3 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','07/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','08/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','09/00Z'])
...
dft6 = pd.DataFrame((zip(trk_fcst_all5,trk_err_all5)), columns = ['FCST_HR','10/00Z'])

summarydf = pd.concat([dft1,dft2['06/00Z'],dft3['07/00Z'],dft4['08/00Z'],dft5['09/00Z'],dft6['10/00Z']], axis=1)
print(summarydf)
...
#PLOTTING
#----------------------------------------
with open('summary_4allstats_Lidia.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['05/00Z','06/00Z','07/00Z','08/00Z','09/00Z','10/00Z']].mean(axis=1)
with open('summary_4onestats_Lidia.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['05/00Z','06/00Z','07/00Z','08/00Z','09/00Z','10/00Z']].std(axis=1)
summarydf['count'] = summarydf[['05/00Z','06/00Z','07/00Z','08/00Z','09/00Z','10/00Z']].count(axis=1)
