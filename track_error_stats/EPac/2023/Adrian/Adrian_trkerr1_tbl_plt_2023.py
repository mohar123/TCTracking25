...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M06/D28/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230628_00+"
beg_date = datetime.datetime(year=2023, month=6, day=28, hour=0)
end_date = datetime.datetime(year=2023, month=7, day=1, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M06/D29/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230629_00+"
beg_date = datetime.datetime(year=2023, month=6, day=29, hour=0)
end_date = datetime.datetime(year=2023, month=7, day=2, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M06/D30/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230630_00+"
beg_date = datetime.datetime(year=2023, month=6, day=30, hour=0)
end_date = datetime.datetime(year=2023, month=7, day=2, hour=6)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M07/D01/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230701_00+"
beg_date = datetime.datetime(year=2023, month=7, day=1, hour=0)
end_date = datetime.datetime(year=2023, month=7, day=2, hour=6)
...
dft4 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','01/00Z'])
...
summarydf = pd.concat([dft1,dft2['29/00Z'],dft3['30/00Z'],dft4['01/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STAS CALC
...
summarydf = pd.concat([dft1,dft2['29/00Z'],dft3['30/00Z'],dft4['01/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Adrian.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['28/00Z','29/00Z','30/00Z','01/00Z']].mean(axis=1)
with open('summary_4onestats_Adrian.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['28/00Z','29/00Z','30/00Z','01/00Z']].std(axis=1)
summarydf['count'] = summarydf[['28/00Z','29/00Z','30/00Z','01/00Z']].count(axis=1)
