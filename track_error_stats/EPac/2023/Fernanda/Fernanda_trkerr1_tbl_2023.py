...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M08/D14/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230814_00+"
beg_date = datetime.datetime(year=2023, month=8, day=14, hour=0)
end_date = datetime.datetime(year=2023, month=8, day=17, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M08/D15/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230815_00+"
beg_date = datetime.datetime(year=2023, month=8, day=15, hour=0)
end_date = datetime.datetime(year=2023, month=8, day=17, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M08/D16/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230816_00+"
beg_date = datetime.datetime(year=2023, month=8, day=16, hour=0)
end_date = datetime.datetime(year=2023, month=8, day=17, hour=18)
...
dft1 = pd.DataFrame((zip(trk_fcst_all,trk_err_all)), columns = ['FCST_HR','14/00Z'])
#print(dft1)
...
dft2 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','15/00Z'])
#print(dft2)
#sys.exit()
...
dft3 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','16/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','17/00Z'])

summarydf = pd.concat([dft1,dft2['15/00Z'],dft3['16/00Z'],dft4['17/00Z']], axis=1)
print(summarydf)
...
with open('summary_4allstats_Fernanda.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['14/00Z','15/00Z','16/00Z','17/00Z']].mean(axis=1)
with open('summary_4onestats_Fernanda.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['14/00Z','15/00Z','16/00Z','17/00Z']].std(axis=1)
summarydf['count'] = summarydf[['14/00Z','15/00Z','16/00Z','17/00Z']].count(axis=1)
