...
with open('summary_4allstats_Hilary.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['17/00Z','18/00Z','19/00Z','20/00Z']].mean(axis=1)
with open('summary_4onestats_Hilary.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['17/00Z','18/00Z','19/00Z','20/00Z']].std(axis=1)
summarydf['count'] = summarydf[['17/00Z','18/00Z','19/00Z','20/00Z']].count(axis=1)
