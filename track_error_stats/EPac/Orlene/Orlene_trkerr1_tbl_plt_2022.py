...
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D30/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220930_00+"
beg_date = datetime.datetime(year=2022, month=9, day=30, hour=0)
end_date = datetime.datetime(year=2022, month=10, day=4, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M10/D01/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20221001_00+"
beg_date = datetime.datetime(year=2022, month=10, day=1, hour=0)
end_date = datetime.datetime(year=2022, month=10, day=4, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M10/D02/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20221002_00+"
beg_date = datetime.datetime(year=2022, month=10, day=2, hour=0)
end_date = datetime.datetime(year=2022, month=10, day=4, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M10/D03/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20221003_00+"
beg_date = datetime.datetime(year=2022, month=10, day=3, hour=0)
end_date = datetime.datetime(year=2022, month=10, day=4, hour=0)
...
beg_date = datetime.datetime(year=2022, month=9, day=30, hour=0)
end_date = datetime.datetime(year=2022, month=10, day=3, hour=12)
...
dft1 = pd.DataFrame((zip(trk_fcst_all,trk_err_all)), columns = ['FCST_HR','30/00Z'])
#print(dft1)
...
dft2 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','01/00Z'])
#print(dft2)
#sys.exit()
...
dft3 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','02/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','03/00Z'])
...
summarydf = pd.concat([dft1,dft2['01/00Z'],dft3['02/00Z'],dft4['03/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STATS CALC
...
summarydf = pd.concat([dft1,dft2['01/00Z'],dft3['02/00Z'],dft4['03/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Orlene.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['30/00Z','01/00Z','02/00Z','03/00Z']].mean(axis=1)
with open('summary_4onestats_Orlene.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['30/00Z','01/00Z','02/00Z','03/00Z']].std(axis=1)
summarydf['count'] = summarydf[['30/00Z','01/00Z','02/00Z','03/00Z']].count(axis=1)
