...
frame['mean'] = frame.iloc[:,:25].mean(axis=1)
frame['stddev'] = frame.iloc[:,:25].std(axis=1)
frame['count'] = frame.iloc[:,:25].count(axis=1)
...
ax.set_title('Atlantic Tropical Cyclone for 2024')
plt.savefig('AtlaAllMeanTrkErr_2024.png')
plt.show()
