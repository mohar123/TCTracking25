...
path = '/discover/nobackup/projects/gmao/obsdev/mchattop/TC_stuff/track_error_stats/Atla' # use your path
...
ax.set_title('Atlantic Tropical Cyclone for 2022')
plt.savefig('AtlaAllMeanTrkErr_2022.png')
plt.show()
