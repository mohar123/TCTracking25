...
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M07/D21/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220721_00+"
beg_date = datetime.datetime(year=2022, month=7, day=21, hour=0)
end_date = datetime.datetime(year=2022, month=7, day=22, hour=0)
...
for file in list_files:
    with xr.open_dataset(file, engine='netcdf4') as f:  
        ...
        slp_1 = f.SLP.sel(lat=slice(21.,23.),lon=slice(-127., -122.0))
...
with open('summary_Estelle_%s00.txt'%time_stamp, 'w') as f:
