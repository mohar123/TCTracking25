...
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D24/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220924_00+"
beg_date = datetime.datetime(year=2022, month=9, day=24, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=30, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D25/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220925_00+"
beg_date = datetime.datetime(year=2022, month=9, day=25, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=30, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D26/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220926_00+"
beg_date = datetime.datetime(year=2022, month=9, day=26, hour=0)
end_date = datetime.datetime(year=2022, month=10, day=1, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D27/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220927_00+"
beg_date = datetime.datetime(year=2022, month=9, day=27, hour=0)
end_date = datetime.datetime(year=2022, month=10, day=2, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D28/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220928_00+"
beg_date = datetime.datetime(year=2022, month=9, day=28, hour=0)
end_date = datetime.datetime(year=2022, month=10, day=3, hour=0)
...
beg_date = datetime.datetime(year=2022, month=9, day=24, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=28, hour=12)
...
dft1 = pd.DataFrame((zip(trk_fcst_all,trk_err_all)), columns = ['FCST_HR','24/00Z'])
#print(dft1)
...
dft2 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','25/00Z'])
#print(dft2)
#sys.exit()
...
dft3 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','26/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','27/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','28/00Z'])
...
summarydf = pd.concat([dft1,dft2['25/00Z'],dft3['26/00Z'],dft4['27/00Z'],dft5['28/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STATS CALC
...
summarydf = pd.concat([dft1,dft2['25/00Z'],dft3['26/00Z'],dft4['27/00Z'],dft5['28/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Ian.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['24/00Z','25/00Z','26/00Z','27/00Z','28/00Z']].mean(axis=1)
with open('summary_4onestats_Ian.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['24/00Z','25/00Z','26/00Z','27/00Z','28/00Z']].std(axis=1)
summarydf['count'] = summarydf[['24/00Z','25/00Z','26/00Z','27/00Z','28/00Z']].count(axis=1)
