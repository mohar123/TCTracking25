...
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D05/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220905_00+"
beg_date = datetime.datetime(year=2022, month=9, day=5, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=10, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D06/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220906_00+"
beg_date = datetime.datetime(year=2022, month=9, day=6, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=11, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D07/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220907_00+"
beg_date = datetime.datetime(year=2022, month=9, day=7, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=11, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D08/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220908_00+"
beg_date = datetime.datetime(year=2022, month=9, day=8, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=11, hour=0)
...
beg_date = datetime.datetime(year=2022, month=9, day=5, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=8, hour=12)
...
summarydf = pd.concat([dft1,dft2['06/00Z'],dft3['07/00Z'],dft4['08/00Z']], axis=1)
print(summarydf)
#sys.exit()
...
summarydf = pd.concat([dft1,dft2['06/00Z'],dft3['07/00Z'],dft4['08/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Earl.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['05/00Z','06/00Z','07/00Z','08/00Z']].mean(axis=1)
with open('summary_4onestats_Earl.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['05/00Z','06/00Z','07/00Z','08/00Z']].std(axis=1)
summarydf['count'] = summarydf[['05/00Z','06/00Z','07/00Z','08/00Z']].count(axis=1)
