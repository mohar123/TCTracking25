...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M06/D22/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230622_00+"
beg_date = datetime.datetime(year=2023, month=6, day=22, hour=0)
end_date = datetime.datetime(year=2023, month=6, day=25, hour=0)
...
beg_date = datetime.datetime(year=2023, month=6, day=23, hour=0)
end_date = datetime.datetime(year=2023, month=6, day=25, hour=0)
...
end_date = datetime.datetime(year=2023, month=6, day=25, hour=6)
...
summarydf = pd.concat([dft1,dft2['23/00Z'],dft3['24/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STAS CALC
...
summarydf = pd.concat([dft1,dft2['23/00Z'],dft3['24/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Bret.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['22/00Z','23/00Z','24/00Z']].mean(axis=1)
with open('summary_4onestats_Bret.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['22/00Z','23/00Z','24/00Z']].std(axis=1)
summarydf['count'] = summarydf[['22/00Z','23/00Z','24/00Z']].count(axis=1)
