...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M09/D18/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230918_00+"
beg_date = datetime.datetime(year=2023, month=9, day=18, hour=0)
end_date = datetime.datetime(year=2023, month=9, day=22, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M09/D19/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230919_00+"
beg_date = datetime.datetime(year=2023, month=9, day=19, hour=0)
end_date = datetime.datetime(year=2023, month=9, day=22, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M09/D20/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230920_00+"
beg_date = datetime.datetime(year=2023, month=9, day=20, hour=0)
end_date = datetime.datetime(year=2023, month=9, day=22, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M09/D21/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230921_00+"
beg_date = datetime.datetime(year=2023, month=9, day=21, hour=0)
end_date = datetime.datetime(year=2023, month=9, day=22, hour=0)
...
beg_date = datetime.datetime(year=2023, month=9, day=18, hour=0)
end_date = datetime.datetime(year=2023, month=9, day=21, hour=18)
...
dft1 = pd.DataFrame((zip(trk_fcst_all,trk_err_all)), columns = ['FCST_HR','18/00Z'])
#print(dft1)
...
dft2 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','19/00Z'])
#print(dft2)
#sys.exit()
...
dft3 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','20/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','21/00Z'])

summarydf = pd.concat([dft1,dft2['19/00Z'],dft3['20/00Z'],dft4['21/00Z']], axis=1)
print(summarydf)
...
summarydf = pd.concat([dft1,dft2['19/00Z'],dft3['20/00Z'],dft4['21/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Nigel.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['18/00Z','19/00Z','20/00Z','21/00Z']].mean(axis=1)
with open('summary_4onestats_Nigel.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['18/00Z','19/00Z','20/00Z','21/00Z']].std(axis=1)
summarydf['count'] = summarydf[['18/00Z','19/00Z','20/00Z','21/00Z']].count(axis=1)
