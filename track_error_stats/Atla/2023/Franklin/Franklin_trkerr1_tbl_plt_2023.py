...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M08/D25/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230825_00+"
beg_date = datetime.datetime(year=2023, month=8, day=25, hour=0)
end_date = datetime.datetime(year=2023, month=8, day=30, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M08/D26/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230826_00+"
beg_date = datetime.datetime(year=2023, month=8, day=26, hour=0)
end_date = datetime.datetime(year=2023, month=8, day=30, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M08/D27/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230827_00+"
beg_date = datetime.datetime(year=2023, month=8, day=27, hour=0)
end_date = datetime.datetime(year=2023, month=8, day=30, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M08/D28/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230828_00+"
beg_date = datetime.datetime(year=2023, month=8, day=28, hour=0)
end_date = datetime.datetime(year=2023, month=8, day=30, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2023/M08/D29/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20230829_00+"
beg_date = datetime.datetime(year=2023, month=8, day=29, hour=0)
end_date = datetime.datetime(year=2023, month=8, day=30, hour=18)
...
dft1 = pd.DataFrame((zip(trk_fcst_all,trk_err_all)), columns = ['FCST_HR','25/00Z'])
#print(dft1)
...
dft2 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','26/00Z'])
#print(dft2)
#sys.exit()
...
dft3 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','27/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','28/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','29/00Z'])

summarydf = pd.concat([dft1,dft2['26/00Z'],dft3['27/00Z'],dft4['28/00Z'],dft5['29/00Z']], axis=1)
print(summarydf)
...
summarydf = pd.concat([dft1,dft2['26/00Z'],dft3['27/00Z'],dft4['28/00Z'],dft5['29/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Franklin.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['25/00Z','26/00Z','27/00Z','28/00Z','29/00Z']].mean(axis=1)
with open('summary_4onestats_Franklin.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['25/00Z','26/00Z','27/00Z','28/00Z','29/00Z']].std(axis=1)
summarydf['count'] = summarydf[['25/00Z','26/00Z','27/00Z','28/00Z','29/00Z']].count(axis=1)
