...
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D02/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220902_00+"
beg_date = datetime.datetime(year=2022, month=9, day=2, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=8, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D03/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220903_00+"
beg_date = datetime.datetime(year=2022, month=9, day=3, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=9, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D04/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220904_00+"
beg_date = datetime.datetime(year=2022, month=9, day=4, hour=0)
...
beg_date = datetime.datetime(year=2022, month=9, day=2, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=6, hour=12)
...
summarydf = pd.concat([dft1,dft2['03/00Z'],dft3['04/00Z'],dft4['05/00Z']], axis=1)
print(summarydf)
#sys.exit()

summarydf = pd.concat([dft1,dft2['03/00Z'],dft3['04/00Z'],dft4['05/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Danielle.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['02/00Z','03/00Z','04/00Z','05/00Z']].mean(axis=1)
with open('summary_4onestats_Danielle.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['02/00Z','03/00Z','04/00Z','05/00Z']].std(axis=1)
summarydf['count'] = summarydf[['02/00Z','03/00Z','04/00Z','05/00Z']].count(axis=1)
