...
beg_date = datetime.datetime(year=2024, month=10, day=20, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=22, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D20/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241020_00+"
beg_date = datetime.datetime(year=2024, month=10, day=20, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=22, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D21/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241021_00+"
beg_date = datetime.datetime(year=2024, month=10, day=21, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=22, hour=18)
...
#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['20/00Z'],dft2['21/00Z'],dft3['22/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STAS CALC
...
summarydf = pd.concat([dft1,dft2['21/00Z'],dft3['22/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Oscar.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['mean'] = summarydf[['20/00Z','21/00Z','22/00Z']].mean(axis=1)
with open('summary_4onestats_Oscar.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['20/00Z','21/00Z','22/00Z']].std(axis=1)
summarydf['count'] = summarydf[['20/00Z','21/00Z','22/00Z']].count(axis=1)
