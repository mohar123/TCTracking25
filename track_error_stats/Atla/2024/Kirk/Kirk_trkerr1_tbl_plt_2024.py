...
beg_date = datetime.datetime(year=2024, month=10, day=1, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=7, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D01/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241001_00+"
beg_date = datetime.datetime(year=2024, month=10, day=1, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=7, hour=18)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D02/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241002_00+"
beg_date = datetime.datetime(year=2024, month=10, day=2, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=7, hour=18)
...
#list if lat >=dely ....
        ...
        lon_slice1 = lon_slice1+(-0.4)
        lon_slice2 = lon_slice2+(0.4)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D03/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241003_00+"
beg_date = datetime.datetime(year=2024, month=10, day=3, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=7, hour=18)
...
#list if lat >=dely ....
        ...
        lat_slice1 = lat_slice1+1.8
        lat_slice2 = lat_slice2+1.8
        lon_slice1 = lon_slice1+(0.5)
        lon_slice2 = lon_slice2+(1.2)
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2)
...
summarydf = pd.concat([dft1,dft2['02/00Z'],dft3['03/00Z'],dft4['04/00Z'],dft5['05/00Z'],dft6['06/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Kirk.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['mean'] = summarydf[['01/00Z','02/00Z','03/00Z','04/00Z','05/00Z','06/00Z']].mean(axis=1)
with open('summary_4onestats_Kirk.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['01/00Z','02/00Z','03/00Z','04/00Z','05/00Z','06/00Z']].std(axis=1)
summarydf['count'] = summarydf[['01/00Z','02/00Z','03/00Z','04/00Z','05/00Z','06/00Z']].count(axis=1)
