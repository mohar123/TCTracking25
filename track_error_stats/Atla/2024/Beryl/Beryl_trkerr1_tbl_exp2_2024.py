...
end_date = datetime.datetime(year=2024, month=7, day=8, hour=12)
...
lon_slice2 = (sel_lat_lon.iloc[0]['c3'])+1
lon_slice1 = lon_slice2 + (-20.)
...
end_date = datetime.datetime(year=2024, month=7, day=6, hour=6)
...
end_date = datetime.datetime(year=2024, month=7, day=7, hour=6)
...
end_date = datetime.datetime(year=2024, month=7, day=8, hour=6)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M07/D05/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240705_00+"
beg_date = datetime.datetime(year=2024, month=7, day=5, hour=0)
end_date = datetime.datetime(year=2024, month=7, day=8, hour=12)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M07/D06/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240706_00+"
beg_date = datetime.datetime(year=2024, month=7, day=6, hour=0)
end_date = datetime.datetime(year=2024, month=7, day=8, hour=12)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M07/D07/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240707_00+"
beg_date = datetime.datetime(year=2024, month=7, day=7, hour=0)
end_date = datetime.datetime(year=2024, month=7, day=8, hour=12)
...
df8 = pd.DataFrame((zip(tim_all9,lat_all9,lon_all9,slp_min_all9,fcst_all9)), columns = ['c1','c2','c3','c4','c5'])
print(df8)
#sys.exit()
#-------------------------------------------------------
#---
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M07/D08/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240708_00+"
beg_date = datetime.datetime(year=2024, month=7, day=8, hour=0)
end_date = datetime.datetime(year=2024, month=7, day=8, hour=12)
...
#list if lat >=dely ....
        ...
        lat_slice1 = lat_slice1+.3
        lat_slice2 = lat_slice2+.3
        lon_slice1 = lon_slice1-0.3
        lon_slice2 = lon_slice2-0.3

df9 = pd.DataFrame((zip(tim_all10,lat_all10,lon_all10,slp_min_all10,fcst_all10)), columns = ['c1','c2','c3','c4','c5'])
print(df9)
#sys.exit()
#----------------------------------------
...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','29/00Z'])
#print(dft2)
#sys.exit()
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','30/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','01/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','02/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all5,trk_err_all5)), columns = ['FCST_HR','03/00Z'])
...
dft6 = pd.DataFrame((zip(trk_fcst_all6,trk_err_all6)), columns = ['FCST_HR','04/00Z'])
...
#dft1 = pd.DataFrame((zip(trk_tim_all,trk_lat_all,trk_lon_all,trk_slp_min_all,trk_err_all)), columns = ['c1','c2','c3','c4','c5'])
dft7 = pd.DataFrame((zip(trk_fcst_all7,trk_err_all7)), columns = ['FCST_HR','05/00Z'])
...
#dft1 = pd.DataFrame((zip(trk_tim_all,trk_lat_all,trk_lon_all,trk_slp_min_all,trk_err_all)), columns = ['c1','c2','c3','c4','c5'])
dft8 = pd.DataFrame((zip(trk_fcst_all8,trk_err_all8)), columns = ['FCST_HR','06/00Z'])
...
#dft1 = pd.DataFrame((zip(trk_tim_all,trk_lat_all,trk_lon_all,trk_slp_min_all,trk_err_all)), columns = ['c1','c2','c3','c4','c5'])
dft9 = pd.DataFrame((zip(trk_fcst_all9,trk_err_all9)), columns = ['FCST_HR','07/00Z'])
...
#dft1 = pd.DataFrame((zip(trk_tim_all,trk_lat_all,trk_lon_all,trk_slp_min_all,trk_err_all)), columns = ['c1','c2','c3','c4','c5'])
dft10 = pd.DataFrame((zip(trk_fcst_all10,trk_err_all10)), columns = ['FCST_HR','08/00Z'])

#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['29/00Z'],dft2['30/00Z'],dft3['01/00Z'],dft4['02/00Z'],dft5['03/00Z'],dft6['04/00Z'],dft7['05/00Z'],dft8['06/00Z'],dft9['07/00Z'],dft10['08/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STAS CALC
...
summarydf = pd.concat([dft1,dft2['30/00Z'],dft3['01/00Z'],dft4['02/00Z'],dft5['03/00Z'],dft6['04/00Z'],dft7['05/00Z'],dft8['06/00Z'],dft9['07/00Z'],dft10['08/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Beryl.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['mean'] = summarydf[['29/00Z','30/00Z','01/00Z','02/00Z','03/00Z','04/00Z','05/00Z','06/00Z','07/00Z','08/00Z']].mean(axis=1)
with open('summary_4onestats_Beryl.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['29/00Z','30/00Z','01/00Z','02/00Z','03/00Z','04/00Z','05/00Z','06/00Z','07/00Z','08/00Z']].std(axis=1)
summarydf['count'] = summarydf[['29/00Z','30/00Z','01/00Z','02/00Z','03/00Z','04/00Z','05/00Z','06/00Z','07/00Z','08/00Z']].count(axis=1)
