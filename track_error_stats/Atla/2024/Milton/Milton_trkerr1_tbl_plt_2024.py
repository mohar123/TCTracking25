...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','06/00Z'])
#print(dft2)
#sys.exit()
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','07/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','08/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','09/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all5,trk_err_all5)), columns = ['FCST_HR','10/00Z'])

#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['06/00Z'],dft2['07/00Z'],dft3['08/00Z'],dft4['09/00Z'],dft5['10/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STAS CALC
...
summarydf = pd.concat([dft1,dft2['07/00Z'],dft3['08/00Z'],dft4['09/00Z'],dft5['10/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Milton.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['mean'] = summarydf[['06/00Z','07/00Z','08/00Z','09/00Z','10/00Z']].mean(axis=1)
with open('summary_4onestats_Milton.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['06/00Z','07/00Z','08/00Z','09/00Z','10/00Z']].std(axis=1)
summarydf['count'] = summarydf[['06/00Z','07/00Z','08/00Z','09/00Z','10/00Z']].count(axis=1)
