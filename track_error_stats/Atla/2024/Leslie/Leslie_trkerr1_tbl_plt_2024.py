...
beg_date = datetime.datetime(year=2024, month=10, day=4, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=12, hour=12)
...
##Changed the date of one of the entries 2024100718 which was repeated twice###
dfo.loc[16, 'c1']='2024100800'
print(dfo)
#sys.exit()
#############TC - 
#---
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D04/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241004_00+"
beg_date = datetime.datetime(year=2024, month=10, day=4, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=9, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D05/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241005_00+"
beg_date = datetime.datetime(year=2024, month=10, day=5, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=10, hour=0)
...
#list if lat >=dely ....
        ...
        lon_slice1 = lon_slice1+(-.75)
        lon_slice2 = lon_slice2+(-.75)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D06/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241006_00+"
beg_date = datetime.datetime(year=2024, month=10, day=6, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=11, hour=0)
...
#list if lat >=dely ....
        ...
        lat_slice1 = lat_slice1+0.7
        lat_slice2 = lat_slice2+0.7
        lon_slice1 = lon_slice1+(-.75)
        lon_slice2 = lon_slice2+(-.75)
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D07/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241007_00+"
beg_date = datetime.datetime(year=2024, month=10, day=7, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=12, hour=0)

lon_all4, lat_all4, slp_min_all4, tim_all4, fcst_all4 = [], [], [], [], []
del_lat = 15.
del_lon = 20.0
sel_lat_lon = (dfo[['c1','c2','c3']][dfo['c1']== beg_date.strftime("%Y%m%d%H")])
print(beg_date.strftime("%Y%m%d%H"))
print(sel_lat_lon.iloc[0]['c2'])
lat_slice1 = (sel_lat_lon.iloc[0]['c2'])
lat_slice2 = lat_slice1 + .5
print(sel_lat_lon.iloc[0]['c3'])
...
#list if lat >=dely ....
        ...
        lat_slice1 = lat_slice1+.6
        lat_slice2 = lat_slice2+.6
        lon_slice1 = lon_slice1+(-.75)
        lon_slice2 = lon_slice2+(.75)
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D08/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241008_00+"
beg_date = datetime.datetime(year=2024, month=10, day=8, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=12, hour=12)
...
print(sel_lat_lon.iloc[0]['c2'])
lat_slice1 = (sel_lat_lon.iloc[0]['c2'])
lat_slice2 = lat_slice1 + .1
print(sel_lat_lon.iloc[0]['c3'])
lon_slice2 = (sel_lat_lon.iloc[0]['c3'])
lon_slice1 = lon_slice2 + (-.4)
...
#list if lat >=dely ....
        ...
        lon_slice2 = lon_slice1+(-.1)
        lon_slice1 = lon_slice2+(-.7)
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D09/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241009_00+"
beg_date = datetime.datetime(year=2024, month=10, day=9, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=12, hour=12)
...
#--------
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D10/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241010_00+"
beg_date = datetime.datetime(year=2024, month=10, day=10, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=12, hour=12)
...
lat_slice2 = lat_slice1 + .1
print(sel_lat_lon.iloc[0]['c3'])
lon_slice1 = (sel_lat_lon.iloc[0]['c3'])-0.1
...
#---------
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M10/D11/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20241011_00+"
beg_date = datetime.datetime(year=2024, month=10, day=11, hour=0)
end_date = datetime.datetime(year=2024, month=10, day=12, hour=12)
...
lat_slice2 = lat_slice1 + .1
print(sel_lat_lon.iloc[0]['c3'])
lon_slice1 = (sel_lat_lon.iloc[0]['c3'])-0.5
lon_slice2 = lon_slice1+.1
...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','04/00Z'])
#print(dft2)
#sys.exit()
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','05/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','06/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','07/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all5,trk_err_all5)), columns = ['FCST_HR','08/00Z'])
...
dft6 = pd.DataFrame((zip(trk_fcst_all6,trk_err_all6)), columns = ['FCST_HR','09/00Z'])
...
dft7 = pd.DataFrame((zip(trk_fcst_all7,trk_err_all7)), columns = ['FCST_HR','10/00Z'])
...
dft8 = pd.DataFrame((zip(trk_fcst_all8,trk_err_all8)), columns = ['FCST_HR','11/00Z'])


#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['04/00Z'],dft2['05/00Z'],dft3['06/00Z'],dft4['07/00Z'],dft5['08/00Z'],dft6['09/00Z'],dft7['10/00Z'],dft8['11/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STAS CALC
...
summarydf = pd.concat([dft1,dft2['05/00Z'],dft3['06/00Z'],dft4['07/00Z'],dft5['08/00Z'],dft6['09/00Z'],dft7['10/00Z'],dft8['11/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Leslie.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['mean'] = summarydf[['04/00Z','05/00Z','06/00Z','07/00Z','08/00Z','09/00Z','10/00Z','11/00Z']].mean(axis=1)
with open('summary_4onestats_Leslie.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['04/00Z','05/00Z','06/00Z','07/00Z','08/00Z','09/00Z','10/00Z','11/00Z']].std(axis=1)
summarydf['count'] = summarydf[['04/00Z','05/00Z','06/00Z','07/00Z','08/00Z','09/00Z','10/00Z','11/00Z']].count(axis=1)
