...
beg_date = datetime.datetime(year=2024, month=9, day=10, hour=0)
end_date = datetime.datetime(year=2024, month=9, day=13, hour=0)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M09/D10/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240910_00+"
beg_date = datetime.datetime(year=2024, month=9, day=10, hour=0)
end_date = datetime.datetime(year=2024, month=9, day=13, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M09/D11/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240911_00+"
beg_date = datetime.datetime(year=2024, month=9, day=11, hour=0)
end_date = datetime.datetime(year=2024, month=9, day=13, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2024/M09/D12/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20240912_00+"
beg_date = datetime.datetime(year=2024, month=9, day=12, hour=0)
end_date = datetime.datetime(year=2024, month=9, day=13, hour=0)
...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','10/00Z'])
#print(dft2)
#sys.exit()
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','11/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','12/00Z'])

#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft1['10/00Z'],dft2['11/00Z'],dft3['12/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STAS CALC
...
summarydf = pd.concat([dft1,dft2['11/00Z'],dft3['12/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Francine.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['mean'] = summarydf[['10/00Z','11/00Z','12/00Z']].mean(axis=1)
with open('summary_4onestats_Francine.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['10/00Z','11/00Z','12/00Z']].std(axis=1)
summarydf['count'] = summarydf[['10/00Z','11/00Z','12/00Z']].count(axis=1)
