...
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D16/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220916_00+"
beg_date = datetime.datetime(year=2022, month=9, day=16, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=21, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D17/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220917_00+"
beg_date = datetime.datetime(year=2022, month=9, day=17, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=22, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D18/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220918_00+"
beg_date = datetime.datetime(year=2022, month=9, day=18, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=23, hour=0)
...
#___
# Obtain the date/time and initial lat/lon from command line:
dirm = "/archive/u/dao_ops/f5294_fp/forecast/Y2022/M09/D19/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20220919_00+"
beg_date = datetime.datetime(year=2022, month=9, day=19, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=24, hour=0)
...
beg_date = datetime.datetime(year=2022, month=9, day=16, hour=0)
end_date = datetime.datetime(year=2022, month=9, day=19, hour=12)
...
summarydf = pd.concat([dft1,dft2['17/00Z'],dft3['18/00Z'],dft4['19/00Z']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#STAS CALC
...
summarydf = pd.concat([dft1,dft2['17/00Z'],dft3['18/00Z'],dft4['19/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Fiona.txt', 'w') as f:
    f.write(summarydf.to_string())

summarydf['mean'] = summarydf[['16/00Z','17/00Z','18/00Z','19/00Z']].mean(axis=1)
with open('summary_4onestats_Fiona.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['16/00Z','17/00Z','18/00Z','19/00Z']].std(axis=1)
summarydf['count'] = summarydf[['16/00Z','17/00Z','18/00Z','19/00Z']].count(axis=1)
