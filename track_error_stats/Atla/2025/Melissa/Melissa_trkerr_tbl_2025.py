...
summarydf = pd.concat([dft1,dft2['23/00Z'],dft3['24/00Z'],dft4['25/00Z'],dft5['26/00Z'],dft6['27/00Z'],dft7['28/00Z'],dft8['29/00Z'],dft9['30/00Z'],dft10['31/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Melissa.txt', 'w') as f:
    f.write(summarydf.to_string())
    summarydf['mean'] = summarydf[['22/00Z','23/00Z','24/00Z','25/00Z','26/00Z','27/00Z','28/00Z','29/00Z','30/00Z','31/00Z']].mean(axis=1)
with open('summary_4onestats_Melissa.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['22/00Z','23/00Z','24/00Z','25/00Z','26/00Z','27/00Z','28/00Z','29/00Z','30/00Z','31/00Z']].std(axis=1)
summarydf['count'] = summarydf[['22/00Z','23/00Z','24/00Z','25/00Z','26/00Z','27/00Z','28/00Z','29/00Z','30/00Z','31/00Z']].count(axis=1)
