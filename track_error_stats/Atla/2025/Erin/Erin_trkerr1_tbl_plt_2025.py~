...
beg_date = datetime.datetime(year=2025, month=8, day=12, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=21, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D12/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250812_00+"
beg_date = datetime.datetime(year=2025, month=8, day=12, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=17, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D13/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250813_00+"
beg_date = datetime.datetime(year=2025, month=8, day=13, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=18, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D14/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250814_00+"
beg_date = datetime.datetime(year=2025, month=8, day=14, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=19, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D15/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250815_00+"
beg_date = datetime.datetime(year=2025, month=8, day=15, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=20, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D16/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250816_00+"
beg_date = datetime.datetime(year=2025, month=8, day=16, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=21, hour=0)
...
for file in list_files:
    with xr.open_dataset(file, engine='netcdf4') as f:
        ...
        slp_1 = f.SLP.sel(lat=slice(lat_slice1,lat_slice2),lon=slice(lon_slice1,
lon_slice2))
        slp_1_min = float(slp_1.min())*0.01
        loc1 = np.where(slp_1[0,:,:] == np.amin(slp_1[0,:,:]))
        lat1 = float(slp_1.lat[loc1[0][0]].values)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D17/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250817_00+"
beg_date = datetime.datetime(year=2025, month=8, day=17, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=22, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D18/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250818_00+"
beg_date = datetime.datetime(year=2025, month=8, day=18, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=23, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D19/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250819_00+"
beg_date = datetime.datetime(year=2025, month=8, day=19, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=24, hour=0)
...
#list if lat >=dely ....
        ...
        lat_slice1 = lat_slice1+0.5
        lat_slice2 = lat_slice2+1.
        lon_slice1 = lon_slice1-.8
        lon_slice2 = lon_slice2+.8
        #print(lat_slice1, lat_slice2, lon_slice1, lon_slice2)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M08/D20/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250820_00+"
beg_date = datetime.datetime(year=2025, month=8, day=20, hour=0)
end_date = datetime.datetime(year=2025, month=8, day=25, hour=0)
...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','12/00Z'])
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','13/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','14/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','15/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all5,trk_err_all5)), columns = ['FCST_HR','16/00Z'])
...
dft6 = pd.DataFrame((zip(trk_fcst_all6,trk_err_all6)), columns = ['FCST_HR','17/00Z'])
...
dft7 = pd.DataFrame((zip(trk_fcst_all7,trk_err_all7)), columns = ['FCST_HR','18/00Z'])
...
dft8 = pd.DataFrame((zip(trk_fcst_all8,trk_err_all8)), columns = ['FCST_HR','19/00Z'])
...
dft9 = pd.DataFrame((zip(trk_fcst_all9,trk_err_all9)), columns = ['FCST_HR','20/00Z'])
#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft2['FCST_HR'],dft3['FCST_HR'],dft4['FCST_HR'],dft5['FCST_HR'],dft6['FCST_HR'],dft7['FCST_HR'],dft8['FCST_HR'],dft9['FCST_HR']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -79.,-25.,15.,44.
...
ax.set_title('TC Track Forecast: Erin Atlantic 2025')

p1, = ax.plot(lon_obs,lat_obs, label="TC Vitals",transform=data_transform,color="black")
p2, = ax.plot(lon_all1,lat_all1, label="Fcst Init: 12/00Z",transform=data_transform,color="lightgreen")
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 13/00Z",transform=data_transform,color="lime")
p4, = ax.plot(lon_all3,lat_all3, label="Fcst Init: 14/00Z",transform=data_transform,color="green")
p5, = ax.plot(lon_all4,lat_all4, label="Fcst Init: 15/00Z",transform=data_transform,color="teal")
p6, = ax.plot(lon_all5,lat_all5, label="Fcst Init: 16/00Z",transform=data_transform,color="cyan")
p7, = ax.plot(lon_all6,lat_all6, label="Fcst Init: 17/00Z",transform=data_transform,color="dodgerblue")
p8, = ax.plot(lon_all7,lat_all7, label="Fcst Init: 18/00Z",transform=data_transform,color="lightgreen")
p9, = ax.plot(lon_all8,lat_all8, label="Fcst Init: 19/00Z",transform=data_transform,color="limegreen")
p10, = ax.plot(lon_all9,lat_all9, label="Fcst Init: 20/00Z",transform=data_transform,color="green")

ax.legend(handles=[p1,p2,p3,p4,p5,p6,p7,p8,p9,p10],prop={"size":6},ncol=3)
...
plt.savefig('TCErin_table_2025.png')
plt.show()
sys.exit()
...
ax.set_title('TC Track Forecast: Erin East Pacific 2025')
