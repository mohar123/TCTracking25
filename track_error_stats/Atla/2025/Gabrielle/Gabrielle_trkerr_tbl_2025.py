...
summarydf = pd.concat([dft1,dft2['19/00Z'],dft3['20/00Z'],dft4['21/00Z'],dft5['22/00Z'],dft6['23/00Z'],dft7['24/00Z'],dft8['25/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Gabrielle.txt', 'w') as f:
    f.write(summarydf.to_string())
    summarydf['mean'] = summarydf[['18/00Z','19/00Z','20/00Z','21/00Z','22/00Z','23/00Z','24/00Z','25/00Z']].mean(axis=1)
with open('summary_4onestats_Gabrielle.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['18/00Z','19/00Z','20/00Z','21/00Z','22/00Z','23/00Z','24/00Z','25/00Z']].std(axis=1)
summarydf['count'] = summarydf[['18/00Z','19/00Z','20/00Z','21/00Z','22/00Z','23/00Z','24/00Z','25/00Z']].count(axis=1)
