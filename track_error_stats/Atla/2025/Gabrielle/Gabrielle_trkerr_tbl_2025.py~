...
beg_date = datetime.datetime(year=2025, month=9, day=18, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=26, hour=18)
...
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D18/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250918_00+"
beg_date = datetime.datetime(year=2025, month=9, day=18, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=23, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D19/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250919_00+"
beg_date = datetime.datetime(year=2025, month=9, day=19, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=24, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D20/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250920_00+"
beg_date = datetime.datetime(year=2025, month=9, day=20, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=25, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D21/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250921_00+"
beg_date = datetime.datetime(year=2025, month=9, day=21, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=26, hour=0)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D22/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250922_00+"
beg_date = datetime.datetime(year=2025, month=9, day=22, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=26, hour=18)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D23/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250923_00+"
beg_date = datetime.datetime(year=2025, month=9, day=23, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=26, hour=18)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D24/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250924_00+"
beg_date = datetime.datetime(year=2025, month=9, day=24, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=26, hour=18)
...
# Obtain the date/time and initial lat/lon from command line:
dirm = "/home/gmao_ops/f5295_fp/run/.../archive/forecast/Y2025/M09/D25/H00/"
col = "GEOS.fp.fcst.inst3_3d_asm_Np.20250925_00+"
beg_date = datetime.datetime(year=2025, month=9, day=25, hour=0)
end_date = datetime.datetime(year=2025, month=9, day=26, hour=18)
...
dft1 = pd.DataFrame((zip(trk_fcst_all1,trk_err_all1)), columns = ['FCST_HR','18/00Z'])
...
dft2 = pd.DataFrame((zip(trk_fcst_all2,trk_err_all2)), columns = ['FCST_HR','19/00Z'])
...
dft3 = pd.DataFrame((zip(trk_fcst_all3,trk_err_all3)), columns = ['FCST_HR','20/00Z'])
...
dft4 = pd.DataFrame((zip(trk_fcst_all4,trk_err_all4)), columns = ['FCST_HR','21/00Z'])
...
dft5 = pd.DataFrame((zip(trk_fcst_all5,trk_err_all5)), columns = ['FCST_HR','22/00Z'])
...
dft6 = pd.DataFrame((zip(trk_fcst_all6,trk_err_all6)), columns = ['FCST_HR','23/00Z'])
...
dft7 = pd.DataFrame((zip(trk_fcst_all7,trk_err_all7)), columns = ['FCST_HR','24/00Z'])
...
dft8 = pd.DataFrame((zip(trk_fcst_all8,trk_err_all8)), columns = ['FCST_HR','25/00Z'])

#---------------------#SUMMARY#----------------------
summarydf = pd.concat([dft1['FCST_HR'],dft2['FCST_HR'],dft3['FCST_HR'],dft4['FCST_HR'],dft5['FCST_HR'],dft6['FCST_HR'],dft7['FCST_HR'],dft8['FCST_HR']], axis=1)
print(summarydf)
#sys.exit()
#----------------------------------------
#PLOTTING
#----------------------------------------
wlon,elon,nlat,slat = -65.,-20.,16.,40.
...
ax.set_title('TC Track Forecast: Gabrielle Atlantic 2025')

p1, = ax.plot(lon_obs,lat_obs, label="TC Vitals",transform=data_transform,color="black")
p2, = ax.plot(lon_all1,lat_all1, label="Fcst Init: 18/00Z",transform=data_transform,color="lightgreen")
p3, = ax.plot(lon_all2,lat_all2, label="Fcst Init: 19/00Z",transform=data_transform,color="lime")
p4, = ax.plot(lon_all3,lat_all3, label="Fcst Init: 20/00Z",transform=data_transform,color="green")
p5, = ax.plot(lon_all4,lat_all4, label="Fcst Init: 21/00Z",transform=data_transform,color="teal")
p6, = ax.plot(lon_all5,lat_all5, label="Fcst Init: 22/00Z",transform=data_transform,color="cyan")
p7, = ax.plot(lon_all6,lat_all6, label="Fcst Init: 23/00Z",transform=data_transform,color="dodgerblue")
p8, = ax.plot(lon_all7,lat_all7, label="Fcst Init: 24/00Z",transform=data_transform,color="lightgreen")
p9, = ax.plot(lon_all8,lat_all8, label="Fcst Init: 25/00Z",transform=data_transform,color="limegreen")

ax.legend(handles=[p1,p2,p3,p4,p5,p6,p7,p8,p9],prop={"size":6},ncol=3)
...
plt.savefig('TCGabrielle_table_2025.png')
plt.show()
sys.exit()
