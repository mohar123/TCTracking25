...
summarydf = pd.concat([dft1,dft2['26/00Z'],dft3['27/00Z'],dft4['28/00Z'],dft5['29/00Z'],dft6['30/00Z']], axis=1)
print(summarydf)
with open('summary_4allstats_Humberto.txt', 'w') as f:
    f.write(summarydf.to_string())
    summarydf['mean'] = summarydf[['25/00Z','26/00Z','27/00Z','28/00Z','29/00Z','30/00Z']].mean(axis=1)
with open('summary_4onestats_Humberto.txt', 'w') as f:
    f.write(summarydf.to_string())
summarydf['stddev'] = summarydf[['25/00Z','26/00Z','27/00Z','28/00Z','29/00Z','30/00Z']].std(axis=1)
summarydf['count'] = summarydf[['25/00Z','26/00Z','27/00Z','28/00Z','29/00Z','30/00Z']].count(axis=1)
